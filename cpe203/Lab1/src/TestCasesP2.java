...
public class TestCasesP2
{
   ...
   {
      assertEquals(0.78539816, new Point(1.0, 1.0).getAngle(), DELTA);
   }

   @Test
   public void testGetAngle2()
   {
      assertEquals(-1.570796, new Point(0.0, -1.0).getAngle(), DELTA);
   }

   @Test
   public void testRotate90()
   {
      final Point testPoint = new Point(1.0, 2.0).rotate90();
