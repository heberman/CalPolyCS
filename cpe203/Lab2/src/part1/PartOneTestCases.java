...
public class PartOneTestCases
{
   ...
   @Test
   public void testPerimeterC1() { assertEquals(6.28319, Util.perimeter(new Circle(new Point(1.0, 1.0), 1.0)), DELTA); }

   @Test
   public void testPerimeterC2() { assertEquals(12.56637, Util.perimeter(new Circle(new Point(1.0, 1.0), 2.0)), DELTA); }

   @Test
   public void testPerimeterR1() { assertEquals(6.0, Util.perimeter(new Rectangle(new Point(1.0, 1.0), new Point(3.0, 2.0))), DELTA); }

   @Test
   public void testPerimeterR2() { assertEquals(6.0, Util.perimeter(new Rectangle(new Point(3.0, 2.0), new Point(1.0, 1.0))), DELTA); }

   @Test
   public void testPerimeterP1() {
      List<Point> input =
              new ArrayList<Point>(Arrays.asList(new Point(0.0,0.0), new Point(2.0,0.0), new Point(0.0,2.0)));
      assertEquals(6.82843, Util.perimeter(new Polygon(input)), DELTA);
   }
   ...
   public void testPerimeterP2() {
      ...
      assertEquals(22.0, Util.perimeter(new Polygon(input)), DELTA);
   }
